...
# https://stackoverflow.com/questions/31123268/finding-intersect-values-using-python-matplot
...
# transform 101 in "case0, case2" ... case1 is 0
def defineClass(index, labels, extreme=None):
    lbls = []
    mat = list(index)
    ones = 0
    ...
    if extreme:
        if ones <= extreme or ones == len(mat):
            return ",".join(lbls)
        else:
            return ""
